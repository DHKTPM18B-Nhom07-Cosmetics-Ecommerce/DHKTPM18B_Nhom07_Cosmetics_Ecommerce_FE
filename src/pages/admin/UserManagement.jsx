...
export default function UserManagement() {
  ...
  const handleApplyFilters = () => {
    setFilters({
      search: tempSearch,
      // Lưu ý: value trong option là rỗng "" nên không cần check string tiếng Anh nữa,
      // nhưng giữ logic cũ cho an toàn nếu value thay đổi
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200 mb-8">
            <div className="flex items-end gap-4 w-full">
              <div className="flex-1">
                <label className="block text-sm font-semibold text-gray-700 mb-2">Tìm kiếm (Tên/Email)</label>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Hiển thị {(page * 10) + 1}-{Math.min((page + 1) * 10, totalUsers)} trong tổng {totalUsers} tài khoản
                  </p>
                </div>
